...
#United States
regression_usa  <- life_expectancy_regression(data_life_expectancy_emission,"United States")
regression_usa
#Zimbabwe
life_expectancy_regression(data_life_expectancy_emission,"Zimbabwe")
